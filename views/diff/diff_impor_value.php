...
<div class="row">
  ...
  <h3 class="box-title">Import Value Diff via Excel</h3>
  </div>
  <!-- /.box-header -->
  <!-- form start -->
...
<div class="col-sm-6"><a href="<?php echo $app_url.'/template_data_value.xlsx';?>">Template file xlsx</a>
  ...
  <button type="submit" name="submit" value="simpanvalue" class="btn btn-info pull-right">Impor Diff Value</button>
  </div>
  <!-- /.box-footer -->
