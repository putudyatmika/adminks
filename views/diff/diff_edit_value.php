...
$r_value=get_value_diff_full($diff_id,urldecode($lvl4));
?>
<div class="row">
  <div class="col-md-6">
            <!-- Horizontal Form -->
  ...
  <h3 class="box-title">Edit Value Diff</h3>
  </div>
  <!-- /.box-header -->
  <!-- form start -->
  ...
  <div class="form-group">
  <label for="inputEmail3" class="col-sm-2 control-label">Waktu Diff</label>
  <div class="col-sm-6">
  <input type="text" class="form-control" id="inputNama" placeholder="Waktu" value="<?php echo $r_value["item"]["value_diff_rincian"];?>" disabled>
  </div>
  </div>
  <div class="form-group">
  <label for="inputEmail3" class="col-sm-2 control-label">Nilai</label>
  <div class="col-sm-6">
  <input type="text" name="value_nilai" class="form-control" id="inputNama" placeholder="Nilai" value="<?php echo $r_value["item"]["value_diff_nilai"];?>" required="">
  </div>
  </div>
    <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Posisi</label>
    <div class="col-sm-4">
    <input type="number" name="value_posisi" class="form-control" id="inputPosisi" placeholder="Posisi" value="<?php echo $r_value["item"]["value_diff_posisi"];?>" required="">
    </div>
    </div>
  </div>
  <!-- /.box-body -->
  ...
  <button type="submit" name="submit" value="simpanvalue" class="btn btn-info pull-right">Update</button>
  </div>
  <!-- /.box-footer -->
  <input type="hidden" name="diff_id" value="<?php echo $diff_id; ?>" />
  <input type="hidden" name="value_waktu" value="<?php echo $r_value["item"]["value_diff_rincian"]; ?>" />
  </form>
  </div>
  <!-- /.box -->
  </div>
