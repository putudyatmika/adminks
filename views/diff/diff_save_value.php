...
if ($_POST['submit']) {
	...
	elseif (cekDiffVarValue($diff_id,TRUE,urldecode($value_waktu))==TRUE) {
		echo 'Data value variabel diff ini sudah tersedia';
	}
	else {
		/*
		echo '
		...
		';*/ 
		if (save_diff_value($diff_id,urldecode($value_waktu),$value_nilai,$value_posisi)==TRUE) echo "Nilai value diff berhasil disimpan";
		else echo 'Nilai value diff tidak bisa di simpan';
	}
